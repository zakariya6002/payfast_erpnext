...
# ------------------
whitelisted_methods = [
    "payfast_integration.payment_gateway.payfast.create_payfast_payment_link"
]

payment_gateway_enabled = ['payfast']

payment_gateway_controller = {
    'Payfast': 'payfast_integration.payment_gateway.payfast'
}

doctype_js = {
    "Sales Invoice": "public/js/sales_invoice_payfast.js"
}
